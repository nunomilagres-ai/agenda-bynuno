...
-- ─── Eventos ──────────────────────────────────────────────────────────────────
-- Recorrência: um evento recorrente é guardado como uma única linha (a primeira
-- ocorrência); as ocorrências seguintes são calculadas em runtime (ver
-- functions/_recurrence.js) e nunca gravadas na BD. Editar/apagar uma ocorrência
-- edita/apaga a série inteira.
